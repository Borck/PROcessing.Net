...
namespace PROcessing.Net.Imaging {
  public static class UnmanagedImageX {
    ...
    /// <returns></returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static int Length(this UnmanagedImage image) => image.Stride * image.Height;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static UnmanagedImage Clone(this UnmanagedImage image) => new UnmanagedImage(
      image.ImageData,
      image.Width,
      image.Height,
      image.Stride,
    ...
    public static ComplexImage GetSubComplexImage(this UnmanagedImage image,
                                                  Rectangle bounds,
                                                  bool zeroPadding) =>
      GetSubComplexImage(image, bounds.X, bounds.Y, bounds.Width, bounds.Height, zeroPadding);



    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ComplexImage GetSubComplexImage(this UnmanagedImage image, Rectangle bounds) =>
      GetSubComplexImage(image, bounds.X, bounds.Y, bounds.Width, bounds.Height);
    ...
    /// </summary>
    /// <param name="image"></param>
    public static ComplexImage ToComplexImageZeroPad(this UnmanagedImage image) => ToComplexImageZeroPad(
      image,
      MathCV.UpperPow2(image.Width),
      MathCV.UpperPow2(image.Height)
    );
