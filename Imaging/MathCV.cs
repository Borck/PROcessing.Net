...
namespace PROcessing.Net.Imaging {
  ...
  public static class MathCV {
    ...
    /// <returns></returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static int Log2Ceil(double a) => ((int)(BitConverter.DoubleToInt64Bits(a) >> 52) & 0x7ff) - 1022;



    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static int OddFloor(int a) => a - ((a & 1) ^ 1);



    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static int EvenFloor(int a) => a & -2;



    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool IsPowerOf2(int a) => (a & (a - 1)) == 0;
    ...
    /// <returns></returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static uint UpperPow2(double a) => UpperPow2((uint)Math.Ceiling(a));
    ...
    /// <returns></returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static int UpperPow2(int a) => (int)UpperPow2((uint)a);



    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static string ToHexString(this int a) => a.ToString("X8");



    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static int RoundToInt(double a) => (int)(a + .5);
    ...
    /// <returns></returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static int Umod(int x, int m) => ((x % m) + m) % m;



    public static double AvgAbs(this Complex[] thisArray) => SumAbs(thisArray) / thisArray.Length;


    public static double SumAbs(this Complex[] thisArray) => thisArray.Sum(c => c.Magnitude);



    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static byte ToBase256(this double value) =>
      value < 0 ? BYTE_MIN : value > 1 ? BYTE_MAX : (byte)(value * BYTE_MAX);
    ...
    public static byte ClampToByte(this double value) =>
      value < BYTE_MIN ? BYTE_MIN : value > BYTE_MAX ? BYTE_MAX : (byte)value;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Complex Transpose(this Complex c) => new Complex(c.Imaginary, c.Real);



    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static double Hypothenuse(double a, double b) => Math.Sqrt((a * a) + (b * b));
    ...
    /// <param name="values"></param>
    /// <returns></returns>
    public static double Variance(this IEnumerable<double> values) => Variance(values as double[] ?? values.ToArray());
    ...
    /// <returns></returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static double ToDeg(double phi) => DEG_TO_RAD * phi;
    ...
    /// <returns></returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static double ToRad(double angle) => RAD_TO_DEG * angle;
    ...
    public static double InterpolateBilinear(double p00, double p01, double p10, double p11, double ax, double ay) =>
      ((((1 - ax) * p00) + (ax * p01)) * (1 - ay)) + ((((1 - ax) * p10) + (ax * p11)) * ay);
