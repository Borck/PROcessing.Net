...
namespace PROcessing.Net.Imaging.Filtering {
  public class LinearScaleSpace : BaseFilter {
    ...
    private static readonly Dictionary<PixelFormat, PixelFormat> Ft =
      new Dictionary<PixelFormat, PixelFormat> {{PixelFormat.Format8bppIndexed, PixelFormat.Format8bppIndexed}};
