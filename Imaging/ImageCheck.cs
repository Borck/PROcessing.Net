...
namespace PROcessing.Net.Imaging {
  ...
  public class ImageCheck : HashSet<PixelFormat> {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public void CheckFormat(PixelFormat format, out int pixelBytes) => pixelBytes = CheckAndGetPixelBytes(format);



    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public void CheckFormat(UnmanagedImage image) => CheckFormat(image.PixelFormat);
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public int CheckAndGetPixelBytes(UnmanagedImage image) => CheckAndGetPixelBytes(image.PixelFormat);
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public bool IsSupported(PixelFormat format) => Contains(format);



    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public bool IsSupported(UnmanagedImage image) => Contains(image.PixelFormat);
    ...
    public new bool IntersectWith(IEnumerable<PixelFormat> other) => throw new NotSupportedException();



    public new bool Remove(PixelFormat pixelFormat) => throw new NotSupportedException();



    public new bool RemoveWhere(Predicate<PixelFormat> match) => throw new NotSupportedException();


    public new bool SymmetricExceptWith(IEnumerable<PixelFormat> other) => throw new NotSupportedException();


    public new bool TrimExcess() => throw new NotSupportedException();


    public new bool UnionWith(IEnumerable<PixelFormat> other) => throw new NotSupportedException();
