...
namespace PROcessing.Net.Imaging {
  public class Complex2D {
    ...
    public Complex2D(int width, int height) => Data = new Complex[(Width = width) * (Height = height)];
    ...
    public bool SameSizeAs(Complex2D channel) => Width == channel.Width && Height == channel.Height;
    ...
    /// </summary>
    /// <param name="factor"></param>
    public void MultiplyWith(double factor) => DoMultiply(this, factor, this);
    ...
    public void DivideBy(double divisor) => DoMultiply(this, 1 / divisor, this);
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public void ForEachRow(Action<Complex[]> action) => ForEachRow(action, this);
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public void ForEachColumn(Action<Complex[]> action) => ForEachColumn(action, this);
    ...
    public Complex[,] ToMatrix() => Data.ToMatrix();



    public Complex[][] ToJagged() => Data.ToJagged();
    ...
    public Complex[][] ToJagged(bool transposed) => Data.ToJagged(transposed);
    ...
    public Complex2D Clone() => new Complex2D(this);
