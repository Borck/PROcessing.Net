...
namespace PROcessing.Net.Imaging.Filtering {
  public static class Fourier {
    ...
    public static ComplexImage FFT2(Bitmap image, bool zeroPadding = true) => FFT2(image.ToUnmanaged(), zeroPadding);
    ...
    /// <returns></returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    private static int FitToCycle(this int u, int ul) => u < 0 ? u + ul : u >= ul ? u - ul : u;
